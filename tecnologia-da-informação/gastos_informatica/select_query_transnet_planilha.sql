...
WHERE 
    C.Data >= TO_DATE('2020-01-01', 'YYYY-MM-DD')
...
SELECT 
    UPPER(TRIM(TO_CHAR(Data, 'Month', 'NLS_DATE_LANGUAGE=PORTUGUESE'))) AS Mes,
    SUM(Valor_Total) AS Valor
FROM B
WHERE
    Data >= TO_DATE('2025-01-01', 'YYYY-MM-DD')
GROUP BY
    UPPER(TRIM(TO_CHAR(Data, 'Month', 'NLS_DATE_LANGUAGE=PORTUGUESE')))