...
CASE 
    ...
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3%' THEN '4.3'
END AS Nivel_2,
...
CASE 
    ...
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.1%' THEN '4.3.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.2%' THEN '4.3.2'
END AS Nivel_3,

CASE 
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.1.1.1%' THEN '3.1.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.1.1.2%' THEN '3.1.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.1.2.1%' THEN '3.1.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.1.2.2%' THEN '3.1.2.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.2.1.1%' THEN '3.2.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.2.1.2%' THEN '3.2.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.2.2.1%' THEN '3.2.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.2.2.2%' THEN '3.2.2.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.3.1.1%' THEN '3.3.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.3.1.2%' THEN '3.3.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.3.2.1%' THEN '3.3.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3.3.2.2%' THEN '3.3.2.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.1.1%' THEN '4.1.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.1.2%' THEN '4.1.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.1.3%' THEN '4.1.1.3'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.2.1%' THEN '4.1.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.2.2%' THEN '4.1.2.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.3.1%' THEN '4.1.3.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.1.3.2%' THEN '4.1.3.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.1%' THEN '4.2.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.2%' THEN '4.2.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.3%' THEN '4.2.1.3'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.4%' THEN '4.2.1.4'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.5%' THEN '4.2.1.5'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.6%' THEN '4.2.1.6'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.7%' THEN '4.2.1.7'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.8%' THEN '4.2.1.8'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.1.9%' THEN '4.2.1.9'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.2.1%' THEN '4.2.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.2.2.2%' THEN '4.2.2.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.1.1%' THEN '4.3.1.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.1.2%' THEN '4.3.1.2'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.2.1%' THEN '4.3.2.1'
    WHEN CC.NR_CONTA_CONTABIL_FORMATADO LIKE '4.3.2.2%' THEN '4.3.2.2'
END AS Nivel_4,


        -- Inverte o sinal dos débitos e créditos
    ...
    WHERE
        CC.NR_CONTA_CONTABIL_FORMATADO LIKE '3%' 
...
SELECT
    ...
    CASE
        ...
        WHEN EXTRACT(MONTH FROM A.Data) = 3 THEN 'MARÇO'
    ...
    A.Nivel_4 || ' - ' || FF.DS_CONTA_CONTABIL AS Nivel_4,
...
LEFT JOIN
    grupogem.contas_contabeis FF ON FF.NR_CONTA_CONTABIL_FORMATADO = A.Nivel_4 AND FF.ID_Empresa = A.Empresa
LEFT JOIN
...
WHERE
    ...
    AND DATA >= TO_DATE('2020-01-01', 'YYYY-MM-DD')
